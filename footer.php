<footer>
			<div class="container mt-5">
				<div class="d-flex pt-4 pb-4">
					<div class="p-0 flex-fill">
						<img width="52" height="52" src="https://cdn.shortpixel.ai/spai/w_65+q_lossy+ret_img+to_webp/https://mainwp.com/wp-content/uploads/2017/03/MainWP-Icon-85.png" data-spai="1" class="attachment-thumbnail size-thumbnail" alt="MainWP" sizes="(max-width: 85px) 100vw, 85px" data-spai-upd="52">
						<div class="slogan"><strong>WordPress Management</strong><br>for Professionals</div>
					</div>
					...
					<div class="p-1 flex-fill">
						<h3 style="font-weight:bold">We Recommend</h3>
						<ul class="footer-menu">
					...
					<div class="p-1 flex-fill">
						<h3 style="font-weight:bold">Developers</h3>
						<ul class="footer-menu">
			...
			<div class="p-3 footer-meta text-white d-flex justify-content-between">
				<span class="copyright">© MainWP - WordPress Management for Professionals 2014 - 2020 -
					<a href="https://mainwp.com/terms-of-service/">Terms of Service</a> -
					<a href="https://mainwp.com/privacy-policy/">Privacy Policy</a> -
					<a href="https://mainwp.com/cookie-policy/">Cookie Policy</a> -
					<a href="https://mainwp.com/support-policy/">Support Policy</a> -
					<a href="https://mainwp.com/refund-policy/">Refund Policy</a> -
					<a href="https://mainwp.com/mainwp-domain-use/">MainWP Domain Use</a>
				</span>
				<span class="footer-meta-social">
					<a href="https://www.facebook.com/mainwp"><i class="fab fa-facebook"></i></a>
					<a href="https://twitter.com/mymainwp"><i class="fab fa-twitter"></i></a>
					<a href="https://meta.mainwp.com/"><i class="fab fa-discourse"></i></a>
				</span>
			</div>
		</footer>
